...
const handleDuplicateFieldsDB = (err) => {
  ...
  //  If the error object contains a property keyValue (which typically holds the field and value that caused the duplicate error),
  // it extracts the value(s) from this property.
  if (err.keyValue) {
